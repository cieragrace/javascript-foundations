...
it('should have top hat as a default favorite accessory', function() {
    var magician = new Magician({ name: 'Scott' });

    assert.equal(magician.favoriteAccessory, 'top hat');
  });

it('should also be able to have a cape as a favorite accessory', function() {
...
it('should be able to do another trick', function() {
...
it('should start with a 10 confidence percentage', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('should gain 10 confidence points per trick', function() {
    var magician = new Magician({ name: 'Leta' });
...
it('should be able to preform a showstopper at 100 confidence percentage', function() {
...
it('should need 100 confidence points and an assistant for a show stopper', function() {
